...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::HEROES_AND_INFO],
    OBJ_CATEGORY::HEROES_AND_INFO,
    $sortOrder->HeroesAndInfo,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::MONSTERS],
    OBJ_CATEGORY::MONSTERS,
    $sortOrder->Monsters,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::BORDER,
    null,
    OBJ_CATEGORY::KEYMASTERS_BORDER,
    null,
    $sortOrder->KeymastersBorder,
    8,
    $ids,
    OC_FLEXTYPE::NONE,
    $obj_all[OBJ_CATEGORY::KEYMASTERS_TENTS],
    $tentKeys,
    $obj_all[OBJ_CATEGORY::BORDER_GATES],
    $bGateKeys,
    $obj_all[OBJ_CATEGORY::BORDER_GUARDS],
    $bGuardKeys,
);
DisplayObjCountTable($table);
...
$table = new OC_Table(
    OC_TABLETYPE::ONE_WAY_MONOLITH_PORTAL,
    null,
    OBJ_CATEGORY::ONE_WAY_MONOLITHS,
    null,
    $sortOrder->OneWayMonoliths,
    8,
    $ids,
    OC_FLEXTYPE::NONE,
    $obj_all[OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
    $entranceKeys,
    $obj_all[OBJ_CATEGORY::ONE_WAY_MONOLITH_EXITS],
    $exitKeys,
);
DisplayObjCountTable($table);
...
$table = new OC_Table(
    OC_TABLETYPE::ONE_WAY_MONOLITH_PORTAL,
    null,
    OBJ_CATEGORY::ONE_WAY_PORTALS,
    null,
    $sortOrder->OneWayPortals,
    4,
    $ids,
    OC_FLEXTYPE::NONE,
    $obj_all[OBJ_CATEGORY::ONE_WAY_PORTAL_ENTRANCES],
    $entranceKeys,
    $obj_all[OBJ_CATEGORY::ONE_WAY_PORTAL_EXITS],
    $exitKeys,
);
DisplayObjCountTable($table);
...
$table = new OC_Table(
    OC_TABLETYPE::TWO_WAY_MONOLITH_PORTAL,
    $obj_all[OBJ_CATEGORY::TWO_WAY_MONOLITHS],
    OBJ_CATEGORY::TWO_WAY_MONOLITHS,
    null,
    $sortOrder->TwoWayMonoliths,
    10,
    null,
    OC_FLEXTYPE::NONE,
    $keys,
...
$table = new OC_Table(
    OC_TABLETYPE::TWO_WAY_MONOLITH_PORTAL,
    $obj_all[OBJ_CATEGORY::TWO_WAY_PORTALS],
    OBJ_CATEGORY::TWO_WAY_PORTALS,
    null,
    $sortOrder->TwoWayPortals,
    10,
    null,
    OC_FLEXTYPE::NONE,
    $keys,
...
$table = new OC_Table(
    OC_TABLETYPE::TWO_WAY_MONOLITH_PORTAL,
    $obj_all[OBJ_CATEGORY::TWO_WAY_SEA_PORTALS],
    OBJ_CATEGORY::TWO_WAY_SEA_PORTALS,
    null,
    $sortOrder->TwoWaySeaPortals,
    5,
    null,
    OC_FLEXTYPE::NONE,
    $keys,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::OTHER_GATEWAYS],
    OBJ_CATEGORY::OTHER_GATEWAYS,
    $sortOrder->OtherGateways,
    null,
    null,
    null,
    OC_FLEXTYPE::END,
...
$ids[] = $mineKeys[7];
$table = new OC_Table(
    OC_TABLETYPE::MINE_WAREHOUSE,
    null,
    OBJ_CATEGORY::MINES_AND_WAREHOUSES,
    null,
    $sortOrder->ResourceTypes,
    8,
    $ids,
    OC_FLEXTYPE::START,
    $sortOrder->Mines,
    $obj_all[OBJ_CATEGORY::MINES],
    $mineKeys,
    $sortOrder->Warehouses,
    $obj_all[OBJ_CATEGORY::WAREHOUSES],
    $warehouseKeys,
);
DisplayObjCountTable($table);
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::DWELLINGS],
    OBJ_CATEGORY::DWELLINGS,
    $sortOrder->Dwellings,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::GARRISONS_QUESTS],
    OBJ_CATEGORY::GARRISONS_QUESTS,
    $sortOrder->GarrisonsQuests,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::WAR_MACHINES_AND_UPGRADES],
    OBJ_CATEGORY::WAR_MACHINES_AND_UPGRADES,
    $sortOrder->WarMachinesAndUpgrades,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::TRADING],
    OBJ_CATEGORY::TRADING,
    $sortOrder->Trading,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::CREATURE_BANKS_ELITE],
    OBJ_CATEGORY::CREATURE_BANKS_ELITE,
    $sortOrder->CreatureBanksElite,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::CREATURE_BANKS_ARTIFACTS],
    OBJ_CATEGORY::CREATURE_BANKS_ARTIFACTS,
    null,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::CREATURE_BANKS_RESOURCES],
    OBJ_CATEGORY::CREATURE_BANKS_RESOURCES,
    null,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::CREATURE_BANKS_CREATURES],
    OBJ_CATEGORY::CREATURE_BANKS_CREATURES,
    null,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::BOATS_AND_AIRSHIPS],
    OBJ_CATEGORY::BOATS_AND_AIRSHIPS,
    $sortOrder->BoatsAndAirships,
    null,
    null,
    null,
    OC_FLEXTYPE::START,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::PRIMARY_SKILLS_1],
    OBJ_CATEGORY::PRIMARY_SKILLS_1,
    $sortOrder->PrimarySkills1,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::PRIMARY_SKILLS_2],
    OBJ_CATEGORY::PRIMARY_SKILLS_2,
    $sortOrder->PrimarySkills2,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::SECONDARY_SKILLS],
    OBJ_CATEGORY::SECONDARY_SKILLS,
    $sortOrder->SecondarySkills,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::MULTI_BONUS],
    OBJ_CATEGORY::MULTI_BONUS,
    $sortOrder->MultiBonus,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::MOVEMENT],
    OBJ_CATEGORY::MOVEMENT,
    $sortOrder->Movement,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::SPECIAL],
    OBJ_CATEGORY::SPECIAL,
    $sortOrder->Special,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::ARTIFACTS],
    OBJ_CATEGORY::ARTIFACTS,
    $sortOrder->Artifacts,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::TREASURES],
    OBJ_CATEGORY::TREASURES,
    $sortOrder->Treasures,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::RESOURCES_1],
    OBJ_CATEGORY::RESOURCES_1,
    $sortOrder->Resources1,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::RESOURCES_2],
    OBJ_CATEGORY::RESOURCES_2,
    $sortOrder->Resources2,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::RESOURCE_GENERATORS],
    OBJ_CATEGORY::RESOURCE_GENERATORS,
    $sortOrder->ResourceGenerators,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::SCOUTING],
    OBJ_CATEGORY::SCOUTING,
    $sortOrder->Scouting,
    null,
    null,
    null,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::MAGICAL_TERRAINS_SPELLS],
    OBJ_CATEGORY::MAGICAL_TERRAINS_SPELLS,
    $sortOrder->MagicalTerrainsSpells,
    null,
    null,
    null,
    OC_FLEXTYPE::NONE,
...
$table = new OC_Table(
    OC_TABLETYPE::NORMAL,
    $obj_all[OBJ_CATEGORY::MAGICAL_TERRAINS_BONUSES],
    OBJ_CATEGORY::MAGICAL_TERRAINS_BONUSES,
    $sortOrder->MagicalTerrainsBonuses,
    null,
    null,
    null,
    OC_FLEXTYPE::END,
...
function DisplayObjCountTable($table)
{
    ...
    echo '<table class="table-small obj-count-table">
			<thead>
				<tr>
					<th colspan="100" class="table__title-bar--small">' .
        $table->category .
        '</td>
				</tr>';
    ...
    switch ($table->tableType) {
        case OC_TABLETYPE::NORMAL:
            ...
            foreach ($table->objects as $objcomboid => $obj) {
                ...
                echo '<tr>
						<td class="obj-count-ids ac nowrap' .
                    $classSuffix .
                    '" nowrap="nowrap">' .
                    $objcomboid .
                    '</td>
        ...
        case OC_TABLETYPE::BORDER:
            ...
            for ($i = 0; $i < $table->typeCount; $i++) {
                ...
                echo '<tr>
                    ...
                    '</td>
						<td class="ac nowrap' .
                    $classSuffixBorderGates .
                    '" nowrap="nowrap">' .
                    $borderGateCount .
                    '</td>
						<td class="ac nowrap' .
                    $classSuffixBorderGuards .
                    '" nowrap="nowrap">' .
                    $borderGuardCount .
                    '</td>
					</tr>';
