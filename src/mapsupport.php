...
class StringConvert
{
	...
	public function CyrLat($string, $type)
	{ // LC= L => C,  CL= C => L
...
function GetCampaignLayout($layout)
{
	switch ($layout) {
		...
		case 2:
			return 'Liberation';
		case 3:
			return 'Song for the Father';
		case 4:
			return 'Dungeons and Devils';
		case 5:
			return 'Long Live the King';
		case 6:
			return 'Spoils of War';
		case 7:
			return 'Seeds of Discontent';
		case 8:
			return 'Dragon Slayer';
		case 9:
			return 'Foolhardy Waywardness';
		case 10:
			return 'Festival of life';
		case 11:
			return 'Dragon\'s Blood';
		case 12:
		...
		case 15:
			return 'Birth of a Barbarian';
		case 16:
			return 'New Beginning';
		case 17:
			return 'Elixir of Life';
		case 18:
			return 'Rise of the Necromancer';
		case 19:
			return 'Unholy Alliance';
		case 20:
			return 'Specter of Power';
		case 21:
			return 'Under rhe Jolly Roger';
		case 22:
			return 'Terror of the Seas';
		case 23:
			return 'Horn of the Abbys';
		case 24:
