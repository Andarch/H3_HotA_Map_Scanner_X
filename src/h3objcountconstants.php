...
class OC_Sort_Order
{
    ...
    public $KeymastersBorder = ["Light Blue", "Green", "Red", "Dark Blue", "Brown", "Purple", "White", "Black"];

    public $OneWayMonoliths = ["Blue", "Pink", "Orange", "Yellow", "Turquoise", "Violet", "Chartreuse", "White"];

    public $OneWayPortals = ["Purple", "Orange", "Red", "Cyan"];
    ...
    public $TwoWaySeaPortals = ["White", "Red", "Blue", "Chartreuse", "Yellow"];

    public $OtherGateways = ["Subterranean Gate", "Town Gate", "Whirlpool"];
    ...
    public $ResourceTypes = ["Wood", "Ore", "Mercury", "Sulfur", "Crystal", "Gems", "Gold", "Abandoned"];
    ...
    public $DwellingsByLevel = ["Level 1", "Level 2", "Level 3", "Level 4", "Level 5", "Level 6", "Level 7"];
    ...
    public $GarrisonsQuests = ["Garrison", "Anti-magic Garrison", "Quest Gate", "Quest Guard"];
    ...
    public $Trading = ["Trading Post", 'Warlock\'s Lab', "Black Market", "Junkman", 'Freelancer\'s Guild'];

    public $CreatureBanksElite = ["Dragon Utopia", "Temple of the Sea", "Ancient Altar"];
    ...
    public $BoatsAndAirships = ["Shipyard", "Boat", "Airship Yard", "Airship"];

    public $PrimarySkills1 = ["Mercenary Camp", "Marletto Tower", "Star Axis", "Garden of Revelation"];
    ...
    public $SecondarySkills = ["Witch Hut", 'Hermit\'s Shack', "University", "Seafaring Academy"];

    public $XP = ["Learning Stone", "Gazebo", "Tree of Knowledge", "Altar of Sacrifice", "Sirens"];

    public $Mana = ["Magic Well", "Magic Spring", "Vial of Mana", "Altar of Mana"];
    ...
    public $Movement = ["Stables", "Trailblazer", "Watering Place", "Lighthouse"];

    public $Morale = ["Temple", "Buoy", "Temple of Loyalty"];

    public $Luck = ["Faerie Ring", "Fountain of Fortune", "Swan Pond", "Mermaid"];

    public $Special = ["Grail", "Obelisk", "Sanctuary", 'Seer\'s Hut', 'Pandora\'s Box', "Event Object"];
    ...
    public $Resources1 = ["Random Resource", "Wood", "Ore", "Mercury", "Sulfur", "Crystal", "Gems", "Gold"];

    public $Resources2 = ["Campfire", "Flotsam", "Jetsam", "Sea Barrel", "Lean To"];

    public $ResourceGenerators = ["Windmill", "Water Wheel", "Mystical Garden", "Derrick", "Prospector"];
