	...
	class HeroesConstants {
		...
		*/
		...
		public $ObjectEx = [
			...
			'4-0' => ['name' => 'Arena', 'category' => OBJECTCATEGORIES::PRIMARY_SKILLS_2],
			...
			'29-0' => ['name' => 'Flotsam', 'category' => OBJECTCATEGORIES::RESOURCES_2],
			...
			'39-0' => ['name' => 'Lean To', 'category' => OBJECTCATEGORIES::RESOURCES_2],
			'41-0' => ['name' => 'Library of Enlightenment', 'category' => OBJECTCATEGORIES::PRIMARY_SKILLS_2],
			...
			'47-X' => ['name' => 'School of Magic', 'category' => OBJECTCATEGORIES::PRIMARY_SKILLS_2],
			'48-0' => ['name' => 'Magic Spring', 'category' => OBJECTCATEGORIES::MANA],
			'49-0' => ['name' => 'Magic Well', 'category' => OBJECTCATEGORIES::MANA],
			'51-0' => ['name' => 'Mercenary Camp', 'category' => OBJECTCATEGORIES::PRIMARY_SKILLS_1],
			...
			'72-0' => ['name' => 'Random Monster L1', 'category' => OBJECTCATEGORIES::MONSTERS],
			'73-0' => ['name' => 'Random Monster L2', 'category' => OBJECTCATEGORIES::MONSTERS],
			'74-0' => ['name' => 'Random Monster L3', 'category' => OBJECTCATEGORIES::MONSTERS],
			'75-0' => ['name' => 'Random Monster L4', 'category' => OBJECTCATEGORIES::MONSTERS],
			'76-0' => ['name' => 'Random Resource', 'category' => OBJECTCATEGORIES::RESOURCES_1],
			'77-0' => ['name' => 'Random Town', 'category' => OBJECTCATEGORIES::TOWNS],
			'78-0' => ['name' => 'Refugee Camp', 'category' => OBJECTCATEGORIES::DWELLINGS],
			'79-0' => ['name' => 'Wood', 'category' => OBJECTCATEGORIES::RESOURCES_1],
			'79-1' => ['name' => 'Mercury', 'category' => OBJECTCATEGORIES::RESOURCES_1],
			'79-2' => ['name' => 'Ore', 'category' => OBJECTCATEGORIES::RESOURCES_1],
			'79-3' => ['name' => 'Sulfur', 'category' => OBJECTCATEGORIES::RESOURCES_1],
			...
			'145-1' => ['name' => 'Sea Barrel', 'category' => OBJECTCATEGORIES::RESOURCES_2],
			'145-2' => ['name' => 'Jetsam', 'category' => OBJECTCATEGORIES::RESOURCES_2],
