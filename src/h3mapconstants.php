	...
	class HeroesConstants {
		...
		*/
		...
		public $ObjectEx = [
			...
			'43-0' => ['name' => 'Monolith – Blue One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-1' => ['name' => 'Monolith – Pink One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-2' => ['name' => 'Monolith – Orange One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-3' => ['name' => 'Monolith – Yellow One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			...
			'43-8' => ['name' => 'Monolith – Turquoise One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-9' => ['name' => 'Monolith – Violet One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-10' => ['name' => 'Monolith – Chartreuse One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			'43-11' => ['name' => 'Monolith – White One-Way Entrance', 'category' => OBJ_CATEGORY::ONE_WAY_MONOLITH_ENTRANCES],
			...
			'72-0' => ['name' => 'Random Monster L1', 'category' => OBJ_CATEGORY::MONSTERS],
			'73-0' => ['name' => 'Random Monster L2', 'category' => OBJ_CATEGORY::MONSTERS],
			'74-0' => ['name' => 'Random Monster L3', 'category' => OBJ_CATEGORY::MONSTERS],
			'75-0' => ['name' => 'Random Monster L4', 'category' => OBJ_CATEGORY::MONSTERS],
			...
			'162-0' => ['name' => 'Random Monster L5', 'category' => OBJ_CATEGORY::MONSTERS],
			'163-0' => ['name' => 'Random Monster L6', 'category' => OBJ_CATEGORY::MONSTERS],
			'164-0' => ['name' => 'Random Monster L7', 'category' => OBJ_CATEGORY::MONSTERS],
