<?php
	...
	class OBJECTCATEGORIES {
			...
			const CREATURE_CONVERSION = 'Creature Conversion';
			const CREATURE_GENERATORS = 'Creature Generators';
			...
			const ONE_WAY_MONOLITH_ENTRANCES = 'One-Way Monolith Entrances';
			const ONE_WAY_MONOLITH_EXITS = 'One-Way Monolith Exits';
	...
	class HeroesConstants {
		...
		*/
		...
		public $ObjectEx = [
			...
			'14-0' => ['name' => 'Swan Pond', 'category' => OBJECTCATEGORIES::BONUS_LUCK],
			'15-0' => ['name' => 'Cover of Darkness', 'category' => OBJECTCATEGORIES::SCOUTING],
			'16-0' => ['name' => 'Cyclops Stockpile', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-1' => ['name' => 'Dwarven Treasury', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-2' => ['name' => 'Griffin Conservatory', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-3' => ['name' => 'Imp Cache', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-4' => ['name' => 'Medusa Stores', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-5' => ['name' => 'Naga Bank', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-6' => ['name' => 'Dragon Fly Hive', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			// '16-7' => ['name' => 'Shipwreck', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			// '16-8' => ['name' => 'Derelict Ship', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			// '16-9' => ['name' => 'Crypt', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			// '16-10' => ['name' => 'Dragon Utopia', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-21' => ['name' => 'Beholders\' Sanctuary', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-22' => ['name' => 'Temple of the Sea', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-23' => ['name' => 'Pirate Cavern', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-24' => ['name' => 'Mansion', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-25' => ['name' => 'Spit', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-26' => ['name' => 'Red Tower', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-27' => ['name' => 'Black Tower', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-28' => ['name' => 'Ivory Tower', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-29' => ['name' => 'Churchyard', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-30' => ['name' => 'Experimental Shop', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-31' => ['name' => 'Wolf Raider Picket', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'16-32' => ['name' => 'Ruins', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			'17-X' => ['name' => 'Dwelling', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
			// '18-0' => ['name' => 'Dwellings 2', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
			// '19-0' => ['name' => 'Dwellings 3', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
			...
			'35-0' => ['name' => 'Hill Fort – Original', 'category' => OBJECTCATEGORIES::CREATURE_CONVERSION],
			'35-1' => ['name' => 'Hill Fort – HotA', 'category' => OBJECTCATEGORIES::CREATURE_CONVERSION],
			...
			'47-X' => ['name' => 'School of Magic', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			'48-0' => ['name' => 'Magic Spring', 'category' => OBJECTCATEGORIES::BONUS_MANA],
			'49-0' => ['name' => 'Magic Well', 'category' => OBJECTCATEGORIES::BONUS_MANA],
			'51-0' => ['name' => 'Mercenary Camp', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			'52-0' => ['name' => 'Mermaid', 'category' => OBJECTCATEGORIES::BONUS_LUCK],
			...
			'61-0' => ['name' => 'Star Axis', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			...
			'78-0' => ['name' => 'Refugee Camp', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
			...
			'92-0' => ['name' => 'Sirens', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			...
			'113-0' => ['name' => 'Witch Hut', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			...
			'144-5' => ['name' => 'Hermit\'s Shack', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			'144-6' => ['name' => 'Gazebo', 'category' => OBJECTCATEGORIES::HERO_UPGRADES],
			...
			'146-2' => ['name' => 'Altar of Mana', 'category' => OBJECTCATEGORIES::BONUS_MANA],
			'146-3' => ['name' => 'Town Gate', 'category' => OBJECTCATEGORIES::OTHER_GATEWAYS],
			'146-4' => ['name' => 'Ancient Altar', 'category' => OBJECTCATEGORIES::CREATURE_BANKS],
			...
			'217-X' => ['name' => 'Random Dwelling – Level', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
			'218-X' => ['name' => 'Random Dwelling – Faction', 'category' => OBJECTCATEGORIES::CREATURE_GENERATORS],
